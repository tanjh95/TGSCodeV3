...
##控制MCP的厚度，孔径间距，倾角
tgshome=/home/tgs/g4work/sg410mt/TGSCodeV3
bin=/home/tgs/g4work/sg410mt/TGSCodeV3/bin
src=/home/tgs/g4work/sg410mt/TGSCodeV3/src
inc=/home/tgs/g4work/sg410mt/TGSCodeV3/inc
...
1)
 ...
 for loop2 in  0 #  0 16.666667 #横移
  do 
   for loop in  0 #45 90 135 #旋转
   do
	for loop3 in 0 #0 16.666667 #纵移
		do
...
ChangeSourcePos $X1 $Y1 $Z1  ##示例是 体素
